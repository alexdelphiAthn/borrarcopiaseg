...
function GetSpecialFolderPath(CSIDLFolder: Integer): string;
var
   FilePath: array [0..260] of char;  //valor de MAX_PATH en WINDOWS.PAS
begin
...
function GetUserFolder:String;
begin
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\BorrarFich\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\BorrarFich\';
end;

function GetLogFolder:String;
begin
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+
                                                      '\BorrarFich\log\archive\');
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\BorrarFich\log\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\BorrarFich\log\';
