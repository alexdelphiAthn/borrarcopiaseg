...
type
  ...
  public
    constructor Create(AVerboseMode: Boolean= False;
                       ALogRetention: Integer = DEFAULT_LOG_RETENTION);
...
constructor TLog.Create(AVerboseMode: Boolean= False;
                        ALogRetention: Integer = DEFAULT_LOG_RETENTION);
